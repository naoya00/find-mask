...
マスクは自分を守るためだけではなく人類を守るためにするものだとニュースで知りました。したがって全員にマスクが行き届かなけば意味がないと思い、本アプリを作成しました。<br><br>
...
## :bulb:工夫したポイント
・ユーザーがストレスを感じないように、UI/UXを考え自分なりに設計したところです。<br>
・実際のチーム開発を想定して、大きな機能を追加する際には、プルリクエストを発行して開発を進めました。<br>
・何ができるアプリなのか、初見のユーザーの方でもわかるように設計しました。<br>
