...
・HTML５（haml)<br>
・css3(SASS)<br>
・jquery(インクリメンタルサーチ、メッセージの非同期化、画像のプレビュー表示、ドロップダウンメニュー、無限スクロール）<br>
...
１つ目のポイントはユーザーにストレスを感じさせないように自分なりに考え、気が利くアプリを目標にフロント実装をしたところです。<br>
クリックできるところには全て、アクションをつけてあります。<br>
headerには常に、全てのサービス飛べるようにメニューバーを設置しております。<br>
また、スマホで見る際にも同じようにheaderから全てのサービスに飛べるように工夫いたしました。<br>
<p align="center">
...
この問題は調べても、答えがありませんでした。そのような問題に直面した際は、各方面から調べた情報を組み合わせ、解決することが大事であると学びました。<br><br>
